...
namespace BooksTask
{
    ...
    public class Book : IEquatable<Book>, IComparable<Book>, IFormattable
    {
        ...
        #region IComparable, IEquatable, IFormattable methods
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            List<object> outputProperties = new List<object>();

            foreach (var letter in format.ToUpper())
            {
                switch (letter)
                {
                    case 'A':
                        outputProperties.Add(this.Author);
                        break;
                    case 'N':
                        outputProperties.Add("P. " + this.PagesNumber.ToString());
                        break;
                    case 'T':
                        outputProperties.Add(this.Title);
                        break;
                    case 'H':
                        outputProperties.Add(this.PublishingHouse);
                        break;
                    case 'C':
                        outputProperties.Add(string.Format(formatProvider, "{0:C}", this.Price));
                        break;
                    case 'Y':
            ...
            return string.Format(formatProvider, string.Join(", ", outputProperties.ToArray()));      
        }
